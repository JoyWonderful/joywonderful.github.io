    ...
    figure.forEach(element => {
      ...
      if (isHljsWithWrap && CONFIG.copycode.style === 'mac') {
        ...
        if (!box) {
          ...
          const dtlang = container.getAttribute('data-language');
          box.setAttribute('data-language', dtlang ? dtlang : "text"); // Add data language for 'relative' there -jywondf
          container.wrap(box);
      ...
      target.insertAdjacentHTML('beforeend', '<div class="copy-btn"><i class="fa fa-clipboard fa-fw"></i></div>'); // modify icon(line 94 to line 126) -jywondf
